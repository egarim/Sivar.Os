...
namespace Sivar.Os.Client.Services
{
    public class ClientAuthenticationService : IAuthenticationService
    {
        ...
        private Sivar.Os.Shared.Services.AuthenticationState? _cachedAuthenticationState;
        ...
        public async Task<Sivar.Os.Shared.Services.AuthenticationState> GetAuthenticationStateAsync()
        {
            try
            {
                ...
                _cachedAuthenticationState = new Sivar.Os.Shared.Services.AuthenticationState
                {
