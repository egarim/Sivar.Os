...
using System.Text;
using Xaf.Sivar.Os.Blazor.Server.Services;
using Xaf.Sivar.Os.WebApi.JWT;
...
namespace Xaf.Sivar.Os.Blazor.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                builder.UseApplication<OsBlazorApplication>();
                ...
                builder.ObjectSpaceProviders
                    ...
                    .WithDbContext<Xaf.Sivar.Os.Module.BusinessObjects.OsEFCoreDbContext>((serviceProvider, options) =>
                    {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "Xaf.Sivar.Os API",
                    Version = "v1",
                    Description = @"Use AddXafWebApi(options) in the Xaf.Sivar.Os.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
                });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Xaf.Sivar.Os WebApi v1");
                });
            }
            else
            {
